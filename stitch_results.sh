...
# PCA model confrontation

ffmpeg \
    -i "results/_pca/image1_interpolated_neural.jpg" -i "results/_pca/image1_interpolated_pca.jpg" -i "results/_pca/image1_ground_truth.jpg" \
    -filter_complex " \
    [0:v]pad=iw:ih+50:0:50:color=white[v0p]; \
    [v0p]drawtext=text='Neural Model':fontcolor=black:fontsize=24:x=(w-text_w)/2:y=20[v0]; \
    [1:v]pad=iw:ih+50:0:50:color=white[v1p]; \
    [v1p]drawtext=text='PCA Model':fontcolor=black:fontsize=24:x=(w-text_w)/2:y=20[v1]; \
    [2:v]pad=iw:ih+50:0:50:color=white[v2p]; \
    [v2p]drawtext=text='Ground Truth':fontcolor=black:fontsize=24:x=(w-text_w)/2:y=20[v2]; \
    [v0][v1][v2]hstack=inputs=3" \
    "results/_pca/horizontal1.jpg"

ffmpeg -i "results/_pca/image2_interpolated_neural.jpg" -i "results/_pca/image2_interpolated_pca.jpg" -i "results/_pca/image2_ground_truth.jpg" -filter_complex "[0:v] [1:v] [2:v] hstack=inputs=3" "results/_pca/horizontal2.jpg"
ffmpeg -i "results/_pca/image3_interpolated_neural.jpg" -i "results/_pca/image3_interpolated_pca.jpg" -i "results/_pca/image3_ground_truth.jpg" -filter_complex "[0:v] [1:v] [2:v] hstack=inputs=3" "results/_pca/horizontal3.jpg"
ffmpeg -i "results/_pca/image4_interpolated_neural.jpg" -i "results/_pca/image4_interpolated_pca.jpg" -i "results/_pca/image4_ground_truth.jpg" -filter_complex "[0:v] [1:v] [2:v] hstack=inputs=3" "results/_pca/horizontal4.jpg"
ffmpeg -i "results/_pca/image5_interpolated_neural.jpg" -i "results/_pca/image5_interpolated_pca.jpg" -i "results/_pca/image5_ground_truth.jpg" -filter_complex "[0:v] [1:v] [2:v] hstack=inputs=3" "results/_pca/horizontal5.jpg"

ffmpeg -i results/_pca/horizontal1.jpg \
 -i results/_pca/horizontal2.jpg \
 -i results/_pca/horizontal3.jpg \
 -i results/_pca/horizontal4.jpg \
 -i results/_pca/horizontal5.jpg \
 -filter_complex "[0:v] [1:v] [2:v] [3:v] [4:v] vstack=inputs=5" "results/_pca/merged.jpg"
