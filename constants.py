constants = {
    ...
    "NEURAL_SIGMA_XY": 0.3,
    "NEURAL_SIGMA_UV": 0.3,
    "NEURAL_MODEL_INPUT_SIZE": (4 * 10),  # (4 * H)
    ...
    "COIN_1_INTERPOLATED_DATA_NEURAL_MODEL_FILE_PATH": "data/coins/1_neural_model_interpolated_data.npz",
    "COIN_2_INTERPOLATED_DATA_NEURAL_MODEL_FILE_PATH": "data/coins/2_neural_model_interpolated_data.npz",
    "COIN_3_INTERPOLATED_DATA_NEURAL_MODEL_FILE_PATH": "data/coins/3_neural_model_interpolated_data.npz",
    "COIN_4_INTERPOLATED_DATA_NEURAL_MODEL_FILE_PATH": "data/coins/4_neural_model_interpolated_data.npz",
    ...
    "SYNTH_SINGLE_OBJECT_2_MATERIAL_3_INTERPOLATED_DATA_NEURAL_MODEL_FILE_PATH": "data/synth/single_2_3_neural_model_interpolated_data.npz",
}
